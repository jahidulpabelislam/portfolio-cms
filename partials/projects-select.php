                ...
                <div class="projects-select" ng-show="isLoggedIn">
                    ...
                    <div class="projects-select__form">
                        <div ng-repeat="project in projects" class="projects-select__option styled-checkbox">
                            <label for="{{ project.id }}" class="styled-checkbox__label">
                                <input type="radio" id="{{ project.id }}" name="project" value="{{ project.id }}" class="input checkbox" ng-model="selectedProject" ng-change="selectProject(project)" tabindex="1" />
