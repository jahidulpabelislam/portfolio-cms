        ...
        <div class="login">
            <div class="container">
                <form class="login__form" ng-submit="logIn()">
                    ...
                    <input ng-model="password" type="password" name="password" id="password" placeholder="mypassword" class="input" tabindex="1" oninput="jpi.helpers.checkInputField(this);" required />
                    ...
                    <button type="submit" value="Log In" class="btn btn--dark-green">Log In</button>
                </form>
            </div>
        </div>
