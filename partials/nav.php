        ...
        <nav class="nav" ng-show="isLoggedIn">
            <div class="container nav__container">
                ...
                <div class="nav__links-container">
                    <ul class="nav__links clearfix">
                        <li class="nav-link__item">
                            <a href="/projects/1/" title="Link to Projects Page" class="nav-item__link js-projects">
                                <span class="screen-reader-text">Projects</span>
                                <i class="fa fa-list-ul"></i>
                            </a>
                        </li>
                        <li class="nav-link__item">
                            <a href="/project/new/" title="Link to New Project Form Page" class="nav-item__link js-new-project">
                ...
                <div class="nav__links-container nav__links-container--left">
                    <ul class="nav__links clearfix">
                        <li class="nav-link__item">
                            <a href="/logout/" title="Link to Logout Page" class="nav-item__link js-logout">
